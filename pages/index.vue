...
function connectToNotion() {
  ...
  // For demo purposes, we're just toggling the connected state
  ...
  <div class="container mx-auto py-8 px-4 max-w-7xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card class="shadow-md">
        ...
        <CardContent>
          <div v-if="!isConnected" class="flex flex-col items-center justify-center min-h-[300px] sm:min-h-[400px] md:min-h-[500px]">
            ...
            >
              <div class="flex justify-between items-center mb-1">
                <div class="flex items-center gap-2">
                  <span class="text-lg font-medium w-8 h-8 flex items-center justify-center rounded-md" :class="field.bgColor || 'bg-gray-100'">
                    {{ field.icon }}
                  </span>
